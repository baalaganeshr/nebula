  ...
  return (
    ...
    >
      ...
      <motion.div 
        ...
        whileHover="hover"
        className="relative aspect-[4/3] w-full overflow-hidden rounded-2xl border border-white/10 bg-zinc-900/50 mb-5 group-hover:border-zinc-500/50 transition-colors duration-500 shadow-2xl shadow-black/20 z-0 cursor-pointer"
      >
        {/* Spotlight Effect */}
        <div 
        ...
        <motion.div 
          ...
          className={`absolute inset-0 ${template.image} opacity-80`}
        />
        ...
        <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
            <motion.div 
              ...
              transition={{ duration: 0.6, ease: [0.25, 1, 0.5, 1] }}
              className="w-[75%] h-[75%] bg-[#050505] rounded-lg border border-white/5 shadow-2xl flex flex-col overflow-hidden z-10 relative"
            >
        ...
        <div className="absolute inset-0 flex items-center justify-center z-30 pointer-events-none">
          <motion.button 
            ...
            className="pointer-events-auto bg-white text-black font-bold px-6 py-3 rounded-full flex items-center gap-2 shadow-xl hover:scale-105 hover:shadow-white/20 transition-transform"
          >
